...
<h4 class="mt-0 header-title">Tambah Data Sub-Ujian</h4>
...
@endif
<form method="post" action="{{ route('sub_ujian.store') }}">
@csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input class="form-control" type="text" id="nama_subujian" name="nama_subujian">
        </div>
    </div>
    <div class="form-group row">
